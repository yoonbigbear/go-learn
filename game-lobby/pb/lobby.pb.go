...
const file_lobby_proto_rawDesc = "" +
	...
	"\fLobbyService\x128\n" +
	"\tJoinMatch\x12\x12.lobby.JoinRequest\x1a\x13.lobby.JoinResponse\"\x000\x01BX\n" +
	"\tcom.lobbyB\n" +
	"LobbyProtoP\x01Z\vgo-learn/pb\xa2\x02\x03LXX\xaa\x02\x05Lobby\xca\x02\x05Lobby\xe2\x02\x11Lobby\\GPBMetadata\xea\x02\x05Lobbyb\x06proto3"
